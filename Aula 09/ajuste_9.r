...
#-----teste de normalidade nos dados do IDH_2000-----#

mod2.ex <- lm(dados$mort_infantil ~ dados$renda_per_capita 
              + dados$indice_gini
              + dados$perc_criancas_extrem_pobres
              + dados$perc_criancas_pobres
              + dados$perc_pessoas_dom_agua_estogo_inadequados
